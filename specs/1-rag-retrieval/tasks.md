# Tasks: Vector Retrieval and Pipeline Validation for RAG Chatbot
...
### User Story 1 (P1):
- [ ] Accepts natural language queries and converts to embeddings
- [ ] Performs similarity search against Qdrant vectors
- [ ] Returns top-k chunks with complete metadata (source URL, section, chunk index)
- [ ] Results are ranked by semantic relevance score
- [ ] Response time is under 2 seconds

### User Story 2 (P2):
- [ ] Handles different query types (conceptual, factual, section-based)
- [ ] Consistent performance across query types
- [ ] Query type classification works accurately

### User Story 3 (P3):
- [ ] Quality metrics are calculated and available
- [ ] Validation endpoint works correctly
- [ ] Retrieval accuracy remains above 80%
